...
var (
	dedicatedColumnsResource = meta.DedicatedColumns{
	...
	dedicatedColumnsSpan = meta.DedicatedColumns{
...
func MakeDedicatedColumns() meta.DedicatedColumns {
	columns := make(meta.DedicatedColumns, 0, len(dedicatedColumnsResource)+len(dedicatedColumnsSpan))
